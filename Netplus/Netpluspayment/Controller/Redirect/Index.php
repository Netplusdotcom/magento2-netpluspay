...
action="' . $gateway_url . '" >
 <input type="text" required="required"  hidden="hidden" name="full_name" value="' . $order->getShippingAddress()->getName() . '"
placeholder="John Doe">
 <input type="text" required="required" hidden="hidden" name="email"  value="' . $order->getShippingAddress()->getEmail() . '"
placeholder="example@email.com">
 <input type="number" hidden="hidden" required="required" name="total_amount"
